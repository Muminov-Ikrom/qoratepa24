...
@section('content')
    @include('backend.sections.navbarSection')
    @include('backend.sections.sidebarSection')
    @include('backend.sections.mainContentSection')
@endsection
{{--<!DOCTYPE html>--}}
{{--<html lang="en">--}}
...
{{--                    <li><a href="bola.html" data-toggle="sidebar" class="nav-link nav-link-lg--}}
{{--									collapse-btn"> <i data-feather="align-justify"></i></a></li>--}}
{{--                    <li><a href="ona.html" class="nav-link nav-link-lg fullscreen-btn">--}}
